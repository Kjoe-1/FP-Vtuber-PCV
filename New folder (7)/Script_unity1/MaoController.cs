...
public class MaoController : MonoBehaviour, ISaveable
{
    ...
    public void PopulateSaveData(MaoPref MaoPref)
    {
        MaoPref.ear_max_threshold = ear_max_threshold;
        MaoPref.ear_min_threshold = ear_min_threshold;
        MaoPref.iris_left_ceiling = iris_left_ceiling;
        MaoPref.iris_right_ceiling = iris_right_ceiling;
        MaoPref.iris_up_ceiling = iris_up_ceiling;
        MaoPref.mar_max_threshold = mar_max_threshold;
        MaoPref.mar_min_threshold = mar_min_threshold;
        MaoPref.change_mouth_form = change_mouth_form;
        MaoPref.mouth_dist_max = mouth_dist_max;
        MaoPref.mouth_dist_min = mouth_dist_min;
    }

    public void LoadFromSaveData(MaoPref MaoPref)
    {
        ear_max_threshold = MaoPref.ear_max_threshold;
        ear_min_threshold = MaoPref.ear_min_threshold;
        iris_left_ceiling = MaoPref.iris_left_ceiling;
        iris_right_ceiling = MaoPref.iris_right_ceiling;
        iris_up_ceiling = MaoPref.iris_up_ceiling;
        mar_max_threshold = MaoPref.mar_max_threshold;
        mar_min_threshold = MaoPref.mar_min_threshold;
        change_mouth_form = MaoPref.change_mouth_form;
        mouth_dist_max = MaoPref.mouth_dist_max;
        mouth_dist_min = MaoPref.mouth_dist_min;
    }
}